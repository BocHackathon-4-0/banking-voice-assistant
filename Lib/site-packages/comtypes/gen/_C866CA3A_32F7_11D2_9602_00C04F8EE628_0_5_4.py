...
__all__ = [
    'SPPHRASE', 'DISPID_SGRSTs_NewEnum', 'eLEXTYPE_PRIVATE11',
    'SVEVoiceChange', 'SITooLoud',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SOTCreateInstance', 'SpeechRecoEvents',
    'SPWT_PRONUNCIATION', 'DISPID_SPAPhraseInfo', 'ISpeechPhraseInfo',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechRecoResult2',
    'SPINTERFERENCE', 'DISPID_SPRulesItem', 'SSTTDictation',
    'SRTEmulated', 'SPSInterjection', '_RemotableHandle',
    'SpeechEngineConfidence', 'SpeechWordType',
    'DISPID_SRGCmdLoadFromFile', 'SGDisplay',
    'DISPID_SVESentenceBoundary', 'SpeechAudioProperties',
    'DISPID_SRCAudioInInterferenceStatus', 'SpVoice',
    'DISPID_SOTDisplayUI', 'SPINTERFERENCE_TOOFAST', 'SpLexicon',
    'SGRSTTDictation', 'SDTAlternates', 'SAFTADPCM_22kHzMono',
    'SpeechFormatType', 'SRERecognition', 'DISPID_SLPsItem',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SWFEAvgBytesPerSec',
    'SREAllEvents', 'SECFDefault',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecognizer',
    'SpeechBookmarkOptions', 'SPEI_MIN_TTS', 'SPSNotOverriden',
    'SRSInactive', 'SPPS_RESERVED4', 'DISPID_SPIElements',
    'DISPID_SRGSetWordSequenceData', 'ISpeechVoice',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVEStreamEnd', 'SpeechLoadOption', 'SpeechStreamFileMode',
    'DISPID_SVPriority', 'ISpeechRecoGrammar', 'ISpProperties',
    'DISPID_SRState', 'SPSHORTCUTTYPE', 'DISPID_SRRAudioFormat',
    'SPFILEMODE', 'SpeechRegistryLocalMachineRoot',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_APP', 'SGRSTTWildcard',
    'DISPID_SRSAudioStatus', 'SPFM_OPEN_READONLY', 'SPAR_Unknown',
    'SP_VISEME_13', 'SP_VISEME_21', 'SPRST_ACTIVE',
    ...
    'SPWORDPRONUNCIATIONLIST', 'SREAdaptation', 'SPLO_STATIC',
    'SPBO_AHEAD', 'SPEI_TTS_PRIVATE', 'SpeechCategoryAppLexicons',
    'SPPS_Function', 'SVP_6', 'ISpeechWaveFormatEx', 'SLOStatic',
    'SpUnCompressedLexicon', 'SDTLexicalForm', 'SVP_21',
    'SPRST_ACTIVE_ALWAYS', 'SpeechDiscardType', 'SRTAutopause',
    'SVEAudioLevel', 'DISPID_SRGetPropertyString', 'SPVPRIORITY',
    'SPPHRASEREPLACEMENT', 'SPEI_FALSE_RECOGNITION',
    'SREPropertyNumChange', 'DISPID_SRRAlternates', 'SVSFDefault',
    'ISpeechObjectTokens', 'DISPID_SPILanguageId', 'SpCustomStream',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVAudioOutputStream',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLWsCount',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SASFreeBufferSpace', 'DISPID_SOTDataKey', 'SP_VISEME_14',
    'DISPID_SRCCreateGrammar', 'SpPhoneticAlphabetConverter',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRSTNextState',
    'eLEXTYPE_PRIVATE1', 'SPEVENT', 'DISPID_SABIBufferSize',
    'DISPID_SRAudioInputStream', 'DISPID_SLWType', 'DISPID_SRRAudio',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_RESERVED7', 'Speech_StreamPos_RealTime',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT48kHz8BitMono',
    'DISPID_SOTCGetDataKey', 'SREPrivate', 'DISPID_SpeechRecognizer',
    'SpeechLexiconType', 'SPCT_DICTATION', 'DISPID_SpeechGrammarRule',
    'SDA_One_Trailing_Space', 'SPEI_PHRASE_START',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechPhraseReplacements',
    'eLEXTYPE_RESERVED8', 'SP_VISEME_10', 'ISpPhoneConverter',
    'DISPID_SLPs_NewEnum', 'SRERecoOtherContext',
    'ISpeechPhraseAlternate', 'DISPID_SPRuleId',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SWFEExtraData',
    'DISPID_SRStatus', 'DISPID_SVSVisemeId', 'SRTReSent',
    'eWORDTYPE_ADDED', 'DISPID_SVSInputSentencePosition',
    'SPCS_ENABLED', 'SVSFNLPMask', 'ISpPhoneticAlphabetConverter',
    'SpeechUserTraining', 'SP_VISEME_12', 'SSFMCreate',
    'SPTEXTSELECTIONINFO', 'DISPID_SVGetVoices',
    'SGDSActiveWithAutoPause', 'SPWT_DISPLAY', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPRDisplayAttributes', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SREmulateRecognition', 'SPEI_RECO_STATE_CHANGE',
    'SAFT24kHz8BitMono', 'DISPID_SpeechObjectToken',
    'SpeechGrammarTagDictation', 'SSFMOpenForRead', 'SRSEDone',
    'DISPID_SVResume', 'DISPID_SRRSaveToMemory',
    'DISPID_SPIGrammarId', 'DISPIDSPTSI_SelectionOffset',
    'SpNotifyTranslator', 'SpeechCategoryAudioOut',
    'DISPID_SRRTLength', 'SpeechAudioVolume',
    'DISPID_SRCERecognition', 'DISPID_SpeechAudioBufferInfo',
    'SVP_20', 'SREAudioLevel', 'SpeechRecoContextState',
    'ISpRecoContext2', 'SVP_8', 'DISPID_SPIAudioStreamPosition',
    'SDTPronunciation', 'DISPID_SDKSetLongValue', 'SECFIgnoreCase',
    'eLEXTYPE_USER', 'DISPID_SPANumberOfElementsInResult',
    'ISpPhoneticAlphabetSelection', 'SPEI_START_INPUT_STREAM',
    'SAFTADPCM_11kHzStereo', 'SpeechPropertyLowConfidenceThreshold',
    'SpeechCategoryVoices', 'ISpeechRecoResult2', 'SPXRO_SML',
    'SAFT12kHz8BitMono', 'SDTAudio', 'ISpeechGrammarRuleState',
    'DISPID_SVAudioOutput', 'ISpeechCustomStream',
    'SPEVENTSOURCEINFO', 'SPLO_DYNAMIC', 'DISPID_SVSkip',
    'SPPS_Unknown', 'SPPROPERTYINFO', 'DISPID_SOTGetDescription',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSAddRuleTransition', 'SVP_12',
    'SECNormalConfidence', 'SPLOADOPTIONS', 'SP_VISEME_15',
    'SPSUnknown', 'SpeechInterference', 'ISpeechRecoResult',
    'SPSEMANTICERRORINFO', 'SAFT16kHz8BitMono',
    'ISpeechPhraseElement', 'DISPID_SDKGetlongValue', 'SRERequestUI',
    'SP_VISEME_0', 'SPFM_CREATE', 'SPGS_ENABLED',
    'DISPID_SPEs_NewEnum', 'DISPID_SGRSTransitions', 'STCLocalServer',
    'DISPID_SRGCmdLoadFromObject', 'SAFT24kHz8BitStereo', 'SFTInput',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPEsCount', 'SVP_4', 'SASClosed',
    ...
    'SDA_Two_Trailing_Spaces', 'ISpNotifyTranslator',
    'DISPID_SPRsItem', 'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE8',
    'SINone', 'SPRECORESULTTIMES', 'SSSPTRelativeToEnd',
    'DISPID_SRCEInterference', 'DISPID_SGRs_NewEnum',
    'SREFalseRecognition', 'ISpSerializeState', 'SVP_1', 'SITooFast',
    'DISPID_SBSWrite', 'SPEI_RESERVED5', 'SAFT11kHz16BitStereo',
    'DISPID_SPRulesCount', 'SVP_10', 'SECFNoSpecialChars',
    'SAFT48kHz16BitStereo', 'SWPKnownWordPronounceable',
    'SPEI_START_SR_STREAM', 'DISPID_SDKEnumKeys',
    'DISPID_SVIsUISupported', 'DISPID_SpeechRecognizerStatus',
    'SPPS_RESERVED3', 'DISPID_SOTRemoveStorageFileName',
    'SREPropertyStringChange', 'DISPID_SpeechBaseStream',
    'ISpRecoCategory', 'STCAll', 'DISPID_SAFType',
    'ISpObjectTokenCategory', 'DISPID_SpeechDataKey', 'SGSDisabled',
    'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSLastBookmarkId', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRuleFirstElement', 'SpStream', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SOTId', 'eLEXTYPE_RESERVED10', 'SpeechVoiceSpeakFlags',
    'ISpeechLexiconWords', 'SRATopLevel', 'DISPID_SPRuleName',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPEsItem', 'SPRST_INACTIVE',
    'SGLexical', 'SpeechTokenShellFolder', 'SDA_No_Trailing_Space',
    'DISPID_SRDisplayUI', 'SRARoot', 'DISPID_SRGCmdLoadFromMemory',
    'SVSFIsFilename', 'DISPID_SOTSetId', 'SpeechDataKeyLocation',
    'SVP_11', 'SAFT11kHz8BitMono', 'eWORDTYPE_DELETED',
    'SAFT48kHz8BitStereo', 'DISPID_SPPConfidence', 'ISpeechLexicon',
    'DISPID_SOTGetStorageFileName', 'SPSHT_NotOverriden',
    'ISequentialStream', 'DISPID_SPPsCount',
    'DISPID_SpeechCustomStream', 'SPRECOSTATE', 'ISpGrammarBuilder',
    'ISpRecoContext', 'DISPID_SPEPronunciation', 'DISPID_SLWLangId',
    'SPRULESTATE', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRCRecognizer', 'DISPID_SVEEnginePrivate', 'SINoSignal',
    'SPEI_END_SR_STREAM', 'DISPID_SLWWord',
    'DISPID_SpeechLexiconWord', 'ISpeechLexiconWord',
    'DISPID_SGRSTPropertyId', 'DISPID_SpeechVoiceEvent',
    'SAFTADPCM_8kHzStereo', 'DISPID_SADefaultFormat',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCEBookmark', 'eLEXTYPE_RESERVED9',
    'DISPID_SPRuleNumberOfElements', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRGetPropertyNumber', 'SGLexicalNoSpecialChars',
    'ISpeechPhraseRules', 'ISpEventSource', 'DISPID_SVEventInterests',
    'DISPID_SRCVoice', 'DISPID_SGRsFindRule', 'DISPID_SGRClear',
    'DISPID_SVStatus', 'DISPID_SGRSAddSpecialTransition',
    'ISpRecognizer2', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPPs_NewEnum', 'DISPID_SASetState', 'SVSFUnusedFlags',
    'STSF_CommonAppData', 'DISPID_SOTCDefault',
    'Speech_Max_Pron_Length', 'SPWT_LEXICAL',
    'SpeechGrammarRuleStateTransitionType',
    'IInternetSecurityMgrSite', 'SGDSActiveUserDelimited', 'SDTAll',
    'DISPID_SLGetPronunciations', 'DISPID_SRCESoundEnd',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRAttributes',
    'Speech_Max_Word_Length', 'DISPID_SRRTStreamTime',
    'SPRST_NUM_STATES', 'DISPID_SRCState',
    'DISPID_SRCEFalseRecognition', 'SVP_9', 'DISPID_SRCEEndStream',
    'DISPID_SOTMatchesAttributes', 'SPCT_SLEEP', 'SBONone',
    'SP_VISEME_17', 'SpInProcRecoContext', 'SPPS_Modifier',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVSpeak',
    'SRSActiveAlways', 'SAFTGSM610_44kHzMono', 'SPAUDIOBUFFERINFO',
    'SpeechRunState', 'DISPID_SASCurrentSeekPosition',
    'SpMMAudioEnum', 'DISPID_SAVolume', 'SRCS_Enabled',
    'DISPID_SLPSymbolic', 'ISpeechPhoneConverter',
    'DISPID_SpeechGrammarRules', 'SVP_19', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT24kHz16BitMono', 'SpMMAudioOut',
    'DISPID_SPRFirstElement', 'DISPID_SOTsCount',
    'DISPID_SOTCEnumerateTokens', 'SAFTText',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCResume',
    'DISPID_SGRSTRule', 'DISPID_SRCSetAdaptationData',
    'ISpeechGrammarRule', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_VOICE_CHANGE',
    'SAFT44kHz16BitStereo', 'DISPID_SpeechPhraseInfo',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPPHRASEPROPERTY', 'SP_VISEME_2',
    'SAFT44kHz16BitMono', 'DISPID_SPPsItem', 'ISpAudio',
    'DISPID_SRGRules', 'ISpeechObjectTokenCategory', 'SDTRule',
    'SAFTNoAssignedFormat', 'DISPID_SAFSetWaveFormatEx',
    '_SPAUDIOSTATE', 'SECFEmulateResult', 'SVSFNLPSpeakPunc',
    'SPVPRI_NORMAL', 'SPAS_RUN', 'DISPID_SPRs_NewEnum',
    'DISPID_SBSSeek', 'SASRun', 'DISPID_SASNonBlockingIO',
    'DISPID_SRRRecoContext', 'SPSERIALIZEDPHRASE', 'DISPIDSPTSI',
    'DISPID_SPRuleChildren', 'DISPID_SPPBRestorePhraseFromMemory',
    '_ISpeechRecoContextEvents', 'DISPID_SDKEnumValues',
    'DISPID_SVEBookmark', 'DISPID_SDKDeleteValue',
    'SpeechEngineProperties', 'SVP_13', 'SpMMAudioIn',
    'DISPID_SGRSTsItem', 'DISPID_SRRPhraseInfo',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechMemoryStream',
    'DISPID_SVPause', 'DISPID_SVWaitUntilDone',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechObjectTokenCategory', 'SPBOOKMARKOPTIONS',
    'eLEXTYPE_PRIVATE9', 'SPPS_Interjection', 'DISPID_SPAsCount',
    'SSSPTRelativeToStart', 'DISPID_SPEActualConfidence',
    'DISPID_SPAStartElementInResult', 'ISpShortcut', 'SREStateChange',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLWs_NewEnum',
    'DISPID_SOTIsUISupported', 'SPINTERFERENCE_NOSIGNAL',
    'SVSFlagsAsync', 'SVSFPersistXML', 'DISPID_SRSClsidEngine',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPEDisplayText',
    'DISPID_SpeechFileStream', 'DISPID_SBSRead', 'SPAUDIOSTATE',
    'SPVISEMES', 'DISPID_SVRate', 'SP_VISEME_18',
    'SAFT16kHz16BitMono', 'ISpRecoResult', 'SPLEXICONTYPE',
    'Speech_StreamPos_Asap', 'SPEI_PHONEME', 'SVEStartInputStream',
    'DISPID_SABufferNotifySize', 'SPSNoun', 'SPVPRI_ALERT',
    'DISPID_SCSBaseStream', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRAddState',
    'SPVPRI_OVER', 'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE4',
    'SAFT16kHz16BitStereo', 'DISPID_SPIStartTime',
    'SpeechPropertyAdaptationOn', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPIAudioSizeBytes', 'SAFTExtendedAudioFormat',
    'SPWF_SRENGINE', 'DISPID_SRCEPropertyStringChange', 'ISpPhrase',
    'SPAS_PAUSE', 'SPWORDTYPE', 'SAFT44kHz8BitStereo',
    'SpeechTokenIdUserLexicon', 'SPEI_MAX_TTS', 'SPPS_NotOverriden',
    'ISpNotifySource', 'SPCATEGORYTYPE', 'SpeechRuleState',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTRemove', 'SAFTDefault',
    'SPPHRASEELEMENT', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechTokenValueCLSID', 'SpeechCategoryRecognizers',
    'SPINTERFERENCE_TOOSLOW', 'STSF_FlagCreate',
    'DISPID_SPELexicalForm', 'STSF_AppData',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SMSGetData', 'SRSActive',
    'DISPID_SRGState', 'DISPID_SRSCurrentStreamNumber',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_MORPHOLOGY',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRAudioInput',
    'SpPhraseInfoBuilder', 'SpeechRecognitionType', 'SPPS_Noncontent',
    'DISPID_SOTCategory', 'ISpeechPhraseElements', 'DISPID_SLPsCount',
    'SPWAVEFORMATTYPE', 'SPPS_RESERVED1',
    'DISPID_SVSInputWordPosition', 'DISPID_SPCLangId',
    'SpResourceManager', 'DISPID_SRCERequestUI', 'SREPhraseStart',
    'DISPID_SRIsUISupported', 'DISPID_SLWsItem',
    'SpeechAudioFormatType', 'DISPID_SPIRule', 'SVPOver',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SLGetWords',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCRetainedAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechDisplayAttributes', 'SpObjectToken', 'DISPID_SABufferInfo',
    'SpeechMicTraining', 'SPPARTOFSPEECH', 'DISPID_SPIGetText',
    'SP_VISEME_4', 'eLEXTYPE_PRIVATE19', 'DISPID_SGRInitialState',
    'DISPID_SOTsItem', 'DISPID_SRCEventInterests', 'SPAR_High',
    'SAFTADPCM_8kHzMono', 'DISPID_SPCPhoneToId', 'UINT_PTR',
    'SPSERIALIZEDRESULT', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SGRsCommit', 'DISPID_SVSPhonemeId',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTText', 'SVSFIsXML',
    'SPEI_VISEME', 'DISPID_SpeechPhraseRules', 'SPEI_RESERVED2',
    'SpeechVoiceEvents', 'SVPAlert', 'eLEXTYPE_RESERVED6',
    'SRTStandard', 'DISPID_SPIEngineId', 'DISPID_SPEAudioSizeTime',
    'SGRSTTRule', 'DISPID_SRCESoundStart', 'SPAS_STOP', 'SPSFunction',
    'SPDKL_CurrentConfig', 'SPVOICESTATUS', 'SBOPause', 'SITooQuiet',
    'ISpeechResourceLoader', 'DISPID_SRCCreateResultFromMemory',
    'ISpRecoGrammar2', 'DISPID_SVEWord',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpObjectToken',
    'DISPID_SPPNumberOfElements', 'SpInprocRecognizer',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT12kHz16BitMono',
    'SGSExclusive', 'SAFTCCITT_uLaw_11kHzMono', 'SPBO_PAUSE',
    'DISPID_SGRSTPropertyValue', 'SVPNormal', 'SpeechCategoryAudioIn',
    'DISPID_SRCEAdaptation', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRProfile', 'DISPID_SRCERecognizerStateChange',
    'SRSEIsSpeaking', 'DISPID_SWFESamplesPerSec', 'SPEI_INTERFERENCE',
    'SpeechVoiceCategoryTTSRate', 'SRSInactiveWithPurge',
    'eLEXTYPE_PRIVATE18', 'SAFTNonStandardFormat', 'SpeechTokenKeyUI',
    'DISPID_SRSNumberOfActiveRules', 'SPRULE', 'SAFT32kHz16BitMono',
    'DISPID_SPISaveToMemory', 'SPAUDIOOPTIONS', 'DISPID_SGRsCount',
    'SpFileStream', 'DISPID_SRCEStartStream',
    'ISpeechGrammarRuleStateTransitions', 'SVEBookmark',
    'ISpStreamFormatConverter', 'DISPID_SGRSRule',
    'SPINTERFERENCE_TOOQUIET', 'SAFTCCITT_uLaw_11kHzStereo',
    'SDTDisplayText', 'DISPID_SRRGetXMLResult', 'SPPHRASERULE',
    'DISPID_SPPId', 'DISPID_SpeechVoice', 'SREStreamStart',
    'DISPID_SpeechGrammarRuleState', 'SRTExtendableParse',
    'SRADefaultToActive', 'SPSTREAMFORMATTYPE',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCreateRecoContext',
    'DISPID_SVVoice', 'SPPS_LMA', 'DISPID_SPPEngineConfidence',
    'SP_VISEME_11', 'DISPID_SpeechPhraseRule', 'DISPID_SVDisplayUI',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGDictationLoad', 'DISPID_SPAs_NewEnum',
    'SPSSuppressWord', 'SVP_15', 'SPEI_MIN_SR',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SDKGetBinaryValue',
    'SP_VISEME_3', 'DISPID_SASState', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SVSFIsNotXML', 'SPSHT_OTHER', 'SpObjectTokenCategory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPWORDLIST',
    'eLEXTYPE_PRIVATE12', 'SGRSTTTextBuffer', 'SVP_17', 'SREBookmark',
    'SP_VISEME_8', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRSetTextFeedback', 'ISpLexicon',
    'ISpeechPhraseReplacement', 'DISPID_SPAsItem',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechLexiconProns',
    'DISPID_SAFGuid', 'DISPID_SRCRetainedAudioFormat',
    'SPRECOCONTEXTSTATUS', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SABIEventBias', 'SPAR_Medium', 'SGDSActive',
    'SP_VISEME_5', 'DISPID_SRCEAudioLevel',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechTokenKeyFiles', 'SVP_2',
    'SpeechTokenContext', 'SpeechRecognizerState',
    'SAFT16kHz8BitStereo', 'ISpEventSink', 'SVF_Emphasis',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPEDisplayAttributes', 'DISPID_SMSAMMHandle',
    'SPSEMANTICFORMAT', 'SpeechRegistryUserRoot', 'SVF_None',
    'DISPID_SRGCommit', 'DISPID_SOTCSetId', 'SVP_16',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPERequiredConfidence', 'DISPID_SLPPartOfSpeech',
    'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE10', 'SpeechVisemeType',
    'SPINTERFERENCE_NOISE', 'ISpeechObjectToken',
    'SVSFParseAutodetect', 'SPEI_REQUEST_UI', 'SpeechAllElements',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRsItem',
    'SPEI_SR_PRIVATE', 'SITooSlow', 'SpeechRetainedAudioOptions',
    'DISPID_SPIReplacements', 'DISPID_SMSSetData', 'SREStreamEnd',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSRunningState', 'SDTProperty',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpStream', 'DISPID_SRCEHypothesis', 'SPEI_RESERVED3',
    'DISPID_SPIGetDisplayAttributes', 'SPINTERFERENCE_TOOLOUD',
    'SRAExport', 'SpeechDictationTopicSpelling', 'SPPS_SuppressWord',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE7', 'SP_VISEME_16',
    'SP_VISEME_19', 'eLEXTYPE_VENDORLEXICON', 'SPFM_NUM_MODES',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPEAudioStreamOffset',
    'SECFIgnoreWidth', 'DISPID_SWFEBitsPerSample', 'SREInterference',
    'DISPID_SpeechPhraseProperty', 'DISPID_SABIMinNotification',
    'DISPID_SVGetAudioInputs', 'SPEI_HYPOTHESIS',
    'SAFT32kHz16BitStereo', 'SAFTGSM610_11kHzMono',
    'ISpeechXMLRecoResult', 'SFTSREngine', 'DISPID_SMSADeviceId',
    'DISPID_SRRTimes', 'SpeechGrammarState', 'SPAUDIOSTATUS',
    'DISPID_SGRsDynamic', 'SPAO_NONE', 'ISpeechRecoResultDispatch',
    'SpeechPropertyComplexResponseSpeed', 'SAFT12kHz16BitStereo',
    'DISPID_SGRName', 'ISpNotifySink', 'SVP_7',
    'DISPID_SpeechRecoResultTimes', 'SPEI_SENTENCE_BOUNDARY',
    '_ISpeechVoiceEvents', 'DISPID_SGRId', 'SPAO_RETAIN_AUDIO',
    'eLEXTYPE_PRIVATE15', 'SpeechStreamSeekPositionType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechPropertyResponseSpeed',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechGrammarWordType',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SGRAddResource',
    'SPSHORTCUTPAIRLIST', 'ISpStreamFormat', 'SRTSMLTimeout',
    'SPDKL_LocalMachine', 'DISPID_SBSFormat',
    'DISPID_SVSLastStreamNumberQueued', 'SWTDeleted', 'SP_VISEME_1',
    'DISPID_SPRuleParent', 'SAFT8kHz8BitStereo',
    'SAFTGSM610_22kHzMono', 'DISPID_SLPType', 'DISPID_SLPLangId',
    'SVEWordBoundary', 'SDKLLocalMachine', 'SPBO_TIME_UNITS',
    'ISpeechAudio', 'DISPID_SLGetGenerationChange',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechAudioFormat',
    'DISPID_SPEEngineConfidence', 'SVSFPurgeBeforeSpeak',
    'SAFTADPCM_11kHzMono', 'DISPID_SPPParent', 'SPFM_OPEN_READWRITE',
    'SDKLCurrentUser', 'DISPID_SRGDictationUnload',
    'DISPID_SWFEChannels', 'SpeechAddRemoveWord', 'DISPID_SVVolume',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechAudio',
    'DISPID_SRRDiscardResultInfo', 'SpeechAudioState',
    'SpeechEmulationCompareFlags', 'DISPID_SPPName',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPRNumberOfElements', 'DISPID_SGRSTsCount',
    'SWPUnknownWordPronounceable', 'DISPID_SRCBookmark',
    'ISpeechPhraseProperties', 'SAFT22kHz16BitMono',
    'SPINTERFERENCE_NONE', 'SVP_18', 'ISpeechPhraseAlternates',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRGCmdLoadFromResource',
    'SpeechSpecialTransitionType', 'DISPID_SVEStreamStart',
    'DISPID_SAStatus', 'SpSharedRecognizer', 'DISPID_SRGReset',
    'SpAudioFormat', 'SDKLCurrentConfig', 'SP_VISEME_9',
    'SSFMCreateForWrite', 'ISpeechBaseStream', 'ISpeechGrammarRules',
    'SDTReplacement', 'SPEVENTENUM', 'SPGS_DISABLED',
    'SpeechTokenKeyAttributes', 'SAFT8kHz16BitStereo',
    'DISPID_SDKOpenKey', 'DISPID_SpeechXMLRecoResult',
    'SpSharedRecoContext', 'SVEEndInputStream', 'SPWORDPRONUNCIATION',
    'DISPID_SGRsAdd', 'SRCS_Disabled', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEVoiceChange', 'DISPID_SRRecognizer', 'ISpRecognizer3',
    'DISPID_SPRsCount', 'SVEAllEvents', 'eLEXTYPE_PRIVATE3',
    'DISPID_SDKSetStringValue', 'DISPID_SVSLastResult',
    'DISPID_SPRuleConfidence', 'SPSHT_Unknown', 'DISPID_SPPValue',
    'SP_VISEME_7', 'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SOTCId',
    'DISPID_SRIsShared', 'SpeechWordPronounceable',
    'SECHighConfidence', 'SAFT8kHz16BitMono', 'tagSTATSTG',
    'SAFT48kHz16BitMono', 'ISpObjectWithToken', 'SP_VISEME_20',
    'ISpeechTextSelectionInformation', 'ISpeechRecoResultTimes',
    'ISpeechPhraseRule', 'DISPID_SpeechAudioStatus', 'SPWF_INPUT',
    'DISPID_SVSLastBookmark', 'SGDSInactive', 'SRAONone',
    'SPCONTEXTSTATE', 'SAFT8kHz8BitMono', 'SPAR_Low',
    'STCRemoteServer', 'DISPID_SRRTTickCount', 'SVEPhoneme',
    'SVSFParseSapi', 'SPCT_SUB_DICTATION', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechLexicon', 'ISpeechPhraseReplacements',
    'ISpeechRecognizer', 'SECLowConfidence', 'SASStop',
    ...
    'SpCompressedLexicon', 'SPPS_Noun', 'SPAS_CLOSED',
    'SpStreamFormatConverter', 'SWTAdded', 'DISPID_SOTGetAttribute',
    'SPXMLRESULTOPTIONS', 'SpMemoryStream', 'SPEI_UNDEFINED',
    'STCInprocHandler', 'eLEXTYPE_RESERVED4',
    'SDA_Consume_Leading_Spaces', 'ISpeechVoiceStatus',
    'SVESentenceBoundary', 'DISPID_SPPFirstElement', 'ISpRecoGrammar',
    'SECFIgnoreKanaType', 'SGSEnabled',
    'SpeechCategoryPhoneConverters', 'DISPID_SpeechRecoContext',
    'WAVEFORMATEX', 'SPBO_NONE', 'SLTApp', 'ISpeechRecognizerStatus',
    'DISPID_SWFEFormatTag', 'SAFTADPCM_44kHzStereo',
    'SPBINARYGRAMMAR', 'SPSHT_EMAIL', 'DISPID_SPIEnginePrivateData',
    'SREHypothesis', 'DISPID_SLAddPronunciation',
    'SAFTADPCM_44kHzMono', 'tagSPPROPERTYINFO', 'SAFT22kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVSFVoiceMask', 'SRAImport',
    'DISPID_SRGSetTextSelection', 'SPSHORTCUTPAIR',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_RECOGNITION', 'SRADynamic',
    'STSF_LocalAppData', 'SPGRAMMARSTATE', 'DISPID_SVEPhoneme',
    'DISPID_SRSSupportedLanguages', 'SPWORD',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_RESERVED6', 'SPSModifier',
    'ISpeechAudioFormat', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SLPPhoneIds', 'DISPID_SRGetFormat', 'SpeechVisemeFeature',
    'SVEViseme', 'SpeechGrammarTagWildcard', 'eLEXTYPE_PRIVATE13',
    'SPRS_INACTIVE', 'DISPID_SMSALineId', 'DISPID_SRGId',
    'ISpXMLRecoResult', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SFSClose',
    'eLEXTYPE_USER_SHORTCUT', 'SGRSTTWord', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCVoicePurgeEvent', 'SVP_0', 'ISpVoice',
    'DISPID_SGRSTType', 'ISpResourceManager',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechRecoResult',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPCS_DISABLED',
    'SPSMF_UPS', 'Speech_Default_Weight', 'SPRS_ACTIVE',
    'ISpeechPhraseProperty', 'SRAInterpreter', 'DISPID_SVEViseme',
    'SPPS_RESERVED2', 'DISPID_SVSCurrentStreamNumber', 'ISpPhraseAlt',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRRTOffsetFromStart',
    'SpPhoneConverter', 'SPDATAKEYLOCATION',
    'IInternetSecurityManager', 'ISpeechAudioStatus',
    'SPCT_SUB_COMMAND', 'DISPID_SLWPronunciations',
    'DISPID_SGRSTWeight', 'LONG_PTR', 'SAFT22kHz16BitStereo',
    'DISPID_SPACommit', 'DISPID_SRCPause', 'SSFMOpenReadWrite',
    'SAFT32kHz8BitMono', 'SPPS_Verb', 'SVP_5', 'SGRSTTEpsilon',
    'DISPID_SPPChildren', 'DISPID_SPARecoResult', 'SPSLMA',
    'DISPID_SAEventHandle', 'SDKLDefaultLocation', 'SSTTTextBuffer',
    'DISPID_SLRemovePronunciation', 'SASPause', 'SPEI_SOUND_END',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSInputWordLength', 'SPDKL_CurrentUser',
    'DISPID_SRGRecoContext', 'SPGRAMMARWORDTYPE',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE20', 'SpWaveFormatEx',
    'SVSFParseMask', 'DISPID_SGRSTPropertyName',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SASCurrentDevicePosition', 'ISpeechDataKey',
    'SRESoundStart', 'DISPID_SVSInputSentenceLength',
    'SPDKL_DefaultLocation', 'SVSFParseSsml',
    'SSSPTRelativeToCurrentPosition', 'SLTUser',
    'SPWORDPRONOUNCEABLE', 'SAFT11kHz8BitStereo',
    'SpeechRecoProfileProperties', 'ISpeechMemoryStream',
    'SPEI_SOUND_START', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFT24kHz16BitStereo', 'SPEI_MAX_SR', 'STCInprocServer',
    'SLODynamic', 'ISpeechMMSysAudio', 'SpShortcut',
    'DISPID_SLGenerationId', 'SRAORetainAudio', 'DISPIDSPRG',
    'SPSVerb', 'SpTextSelectionInformation', 'SGPronounciation',
    'DISPID_SVEAudioLevel', 'SPEI_SR_BOOKMARK',
    'DISPID_SRSetPropertyString', 'DISPID_SDKDeleteKey',
    'SP_VISEME_6', 'SpeechRuleAttributes', 'SVEPrivate',
    'eLEXTYPE_PRIVATE17', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechRecoContext', 'DISPID_SDKGetStringValue', 'IEnumString',
    'SPCT_COMMAND', 'SINoise', 'DISPIDSPTSI_SelectionLength',
    'SRESoundEnd', 'DISPID_SRGetRecognizers', 'SVP_3',
    'DISPID_SPRText', 'DISPID_SDKCreateKey',
    'SpeechAudioFormatGUIDWave', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFT44kHz8BitMono', 'SpeechPartOfSpeech', 'DISPID_SFSOpen',
    'DISPID_SPIProperties', 'IEnumSpObjectTokens',
    'eLEXTYPE_PRIVATE16', 'SAFT11kHz16BitMono', 'ISpDataKey',
    'DISPID_SpeechLexiconWords', 'ISpeechAudioBufferInfo',
    'SPEI_RESERVED1', 'DISPID_SAFGetWaveFormatEx', 'SVP_14',
    'SSTTWildcard', 'ISpMMSysAudio'
]

_check_version('1.2.0', 1611784044.749418)
